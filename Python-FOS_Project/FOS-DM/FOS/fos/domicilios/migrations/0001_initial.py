# Generated by Django 4.2.7 on 2023-11-17 04:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='domiciles', to='domicilios.city')),
                ('cod_status_domicile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='domiciles', to='domicilios.domicile_status')),
            ],
            options={
