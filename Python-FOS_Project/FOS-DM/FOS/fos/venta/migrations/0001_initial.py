    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.PositiveIntegerField(verbose_name='Descuento')),
                ('Status_p', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='venta.product_status')),
                ('category_p', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='venta.product_category')),
            ],
            options={
