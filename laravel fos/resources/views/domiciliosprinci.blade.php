...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('CSS/domiciliosprinci2.css')}}">
...
<body>
    ...
    <main>
        <h1 class="admTi">Consultar domicilios</h1>

        <!--Grupo: Numero de factura-->
        <form action="{{ asset('lading')}}" class="formulario" id="formulario">
            ...
            <div>
                <div class="formular__grupo formulario__grupo-btn-enviar">
                    <button type="submit" class="formulario__btn">Consultar</button>
        ...
        <div >
            <a href="{{ asset('verdomicilios')}}">
            <button action="" type="submit" class="formulario__btn2 ">Ver domicilios</button>

            </a>
        </div>
    
    </main>
    <script src="{{ asset ('js/admprinci.js')}}"></script>
